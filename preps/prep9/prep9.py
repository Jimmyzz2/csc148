...
class BinarySearchTree:
    ...
    def count(self, item: Any) -> int:
        ...
        >>> left._left = BinarySearchTree(4)
        >>> left._right = BinarySearchTree(4)
        >>> right = BinarySearchTree(8)
        >>> right._left = BinarySearchTree(8)
        >>> right._right = BinarySearchTree(8)
        >>> bst._left = left
        >>> bst._right = right
        >>> bst.items()
        [4, 4, 4, 7, 8, 8, 8]
    ...
    def items(self) -> List:
        ...
        >>> left = BinarySearchTree(28)
        >>> left._left = BinarySearchTree(28)
        >>> left._right = BinarySearchTree(29)
        >>> right = BinarySearchTree(30)
        >>> right._left = BinarySearchTree(30)
        >>> right._right = BinarySearchTree(32)
        >>> bst._left = left
        >>> bst._right = right
        >>> bst.items()
        [28, 28, 29, 30, 30, 30, 32]
        """
        if self.is_empty():
            return []
        else:
    ...
    def delete(self, item) -> None:
        ...
        if self.is_empty():
            ...
            self._delete_root(item)
        elif item < self._root:
            self._left.delete_item()
        else:
            self._right.delete_item()
