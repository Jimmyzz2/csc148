...
def test_reverse_top_two_doctest2() -> None:
    """This is not the doctest given in reverse_top_two."""
    stack = Stack()
    stack.push(1)
    stack.push(2)
    stack.push(4)
...
def test_reverse_top_two_doctes3() -> None:
    """This is not the doctest given in reverse_top_two."""
    stack = Stack()
    stack.push(1)
    stack.push(2)
...
def test_remove_all_doctest2() -> None:
    """This is the doctest given in remove_all."""
    queue = Queue()
    queue.enqueue(1)
    queue.enqueue(2)
...
def test_remove_all_but_one_doctest3() -> None:
    """Test is the doctest given in remove_all_but_one."""
    queue = Queue()
    queue.enqueue(1)
    queue.enqueue(2)
