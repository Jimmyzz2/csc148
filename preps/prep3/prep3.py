...
class Employee:
    ...
    salary_paid: This employee's salary recieved
    """
    id_: int
    name: str
    salary_paid: int
...
class AnotherEmployee(Employee):
    """An employee whose pay is computed based on an hourly rate.
...
class Company:
    ...
    def total_payroll(self) -> float:
        ...
        for employee in self.employees:
            total_company_payment += employee.total_pay()
        return total_company_payment
